...
import { searchThreatIntel } from "../search/threatIntel.service.js";
...
export const searchService = {
  async globalSearch(params: SearchParams) {
    ...
    const [investigations, reports, scammers, graphNodes, timeline, evidence,threatIntel] = await Promise.all([
    ...
    return { investigations, reports, scammers, graphNodes, timeline, evidence,threatIntel };
  },
  ...
  emptyResults() {
    return { investigations: [], reports: [], scammers: [], graphNodes: [], timeline: [], evidence: [] ,threatIntel : null};
  },
};
