    ...
    <div className="space-y-5 pb-8">
      ...
      {!loading && results && total > 0 && (
        <div className="space-y-5">
          ...
          {/* Threat Intelligence */}
{results.threatIntel && (
  <ResultSection title="Threat Intelligence" count={1}>
    <div className="px-4 py-3 rounded-xl bg-white/[0.012] border border-[rgba(236,154,163,0.04)]">
      <p><strong>Indicator:</strong> {results.threatIntel.indicator}</p>
      <p><strong>Type:</strong> {results.threatIntel.type}</p>
      <p><strong>Country:</strong> {results.threatIntel.country_name}</p>
      <p><strong>City:</strong> {results.threatIntel.city}</p>
      <p><strong>ASN:</strong> {results.threatIntel.asn}</p>
      <p><strong>Reputation:</strong> {results.threatIntel.reputation}</p>
      <p><strong>Pulses:</strong> {results.threatIntel.pulse_info?.count ?? 0}</p>
    </div>
  </ResultSection>
)}
